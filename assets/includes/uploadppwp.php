    ...
    if (isset($_POST['submit'])) {
        ...
        $address = mysqli_real_escape_string($con, $_POST['address']);
            ...
            if (!preg_match("/^[a-zA-Z]*$/", $fname) || !preg_match("/^[a-zA-Z]*$/", $lname)) {
                ...
                header("Location:../personalprofilewithphoto.php?invalid first name or last name");
                exit();
            } else {
                ...
                if (mysqli_num_rows($var2)) {
                    header("Location:../personalprofilewithphoto.php?update = sucess");
                    exit();
                } else {
                    header("Location:../personalprofilewithphoto.php?update = unable to update");
                    exit();
                }
            }
